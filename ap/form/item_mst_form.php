<form method="POST" id="item_mst_form" style="height:350px; margin-top:5px; overflow:auto">
    <div class="form_top"><!--Start Form_top-->     
        ...
        <div class="form_left">
            ...
            <div class="field">
                <label>Code: * <?php if(!empty($i_code)) echo $i_code; ?> </label>
                <div class="data">
                    ...
                    <?php if(!empty($i_code))  echo 'hidden="hidden"'; ?> > 
                </div>                        	
            </div>
            <div class="field">
                <label>Item type: *</label>
                <?php select_item_type($con, @$item_type_id); ?>                       	
            </div>
            <div class="field">
                <label>Name: *</label>
                <div class="data">
        ...
        <div class="form_right">
            ...
            <div class="field">
                <label> Details: </label>
                <div class="data">
                	<textarea class="textarea rich_text" id="i_details" name="i_details" placeholder="Enter Details"><?php  if(!empty($i_details)){ echo $i_details;} ?></textarea>
            	</div>
            </div>       
            <!--<div class="field">
