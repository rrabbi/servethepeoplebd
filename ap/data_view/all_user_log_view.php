<div class="data_list_content data_list_content_search" style="max-height:310px; overflow:auto;">
    <table class="table">
        <tr class="table_head">        	
        ...
        <?php							
            //$query ="SELECT * FROM user_log ORDER BY datetime DESC";
			$query ="SELECT ul.user_id, ul.ip, ul.remote_host, ul.datetime, ul.remark, lt.log_type_name
					FROM user_log AS ul
