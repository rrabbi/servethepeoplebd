    	...
    	<div class="row" style="margin-right:3px;" >
            <div class="col-md-12" >
            	<?php
					...
					$art_query->execute(array(':a_status'=>1, ':a_code'=>'CPROJECT001'));
	...
	<div class="col-md-8" style="">
    	 <div class="panel-group" id="accordion">
				<?php
					...
					$article_query->execute(array(':a_status'=>1, ':ac_code'=>'CHILD-PROGRAM')); //CHILD-PROGRAM
                            ...
                            <div class="panel panel-danger" style="//background:#E7395B">
                                <div class="panel-heading">
                                  ...
                                  <div id="collapse-'.$row['article_id'].'" class="panel-collapse collapse"><br>
                                    <div class="panel-body" style="padding:0px;//background:#FFFFFF;">
										<div class="col-md-7">
											<img src="files/article/'.$row['a_img'].'" alt="" class="img-thumbnail" style="width:100%; max-height:250px;border:none;" >
										</div>
										<div class="col-md-5">'.$row['a_desc'].'</div>                                      
                                    </div>
